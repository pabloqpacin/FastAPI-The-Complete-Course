...
class BookRequest(BaseModel):
    ...
    published_date:int =Field(lt=9999)
...
BOOKS=[
    Book(1,'Computer Science Pro','Setenova','A very nice book!',2024,5),
    Book(2,'Be Fast with FastAPI','Setenova','A great book!',2024,5),
    Book(3,'Master Endpoints','Setenova','An awesome book!',2024,5),
    Book(4,'HP1','Author 1','Book Description',2014,2),
    Book(5,'HP2','Author 2','Book Description',1991,3),
    Book(6,'HP3','Author 3','Book Description',1984,1)
]
